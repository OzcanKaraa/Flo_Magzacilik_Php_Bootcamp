...
#isset değer var mı anladında boş gelip gelmediğini kontrol eder.
    $baslik=$_POST['baslik'];
...
# gelen değerleri yakalama işlemleri tamam

#select listelemek demektir.
#insert yüklemek demektir.
#update güncellemek demektir.
#delete silme demektir

    $yukle=$baglan->prepare("UPDATE ayarlar SET
#veritabanındaki değerleri buraya yazdık.
ayar_baslik=?,
ayar_aciklama=?,
ayar_key=?,
ayar_telefon=?,
...
ayar_facebook=?,
ayar_instagram=?
#neye göre alacağımı beliriyoruz.
WHERE ayar_id=0");
...
resim.png unuttum
resim.png
karışlıklığı önlemek adına rastgele sayı üsretiyoruz.
*/
...
ilan_resim=?
 ");
    $degistir=$yukle->execute(array(
        $id,$katid,$baslik,$aciklama,$sira,$anahtarkelime,$model,$adres,$fiyat,$resimyolu
...
WHERE ilan_id=$id
 ");
        ...
        $degistir=$yukle->execute(array(
            ...
            $altkatid,$katid,$baslik,$aciklama,$sira,$anahtarkelime,$marka,$model,$adres,$fiyat,$resimyolu
  ...
  WHERE ilan_id=$id
   ");
        ...
        $degistir=$yukle->execute(array(
            ...
            $altkatid,$katid,$baslik,$aciklama,$sira,$anahtarkelime,$marka,$model,$adres,$fiyat

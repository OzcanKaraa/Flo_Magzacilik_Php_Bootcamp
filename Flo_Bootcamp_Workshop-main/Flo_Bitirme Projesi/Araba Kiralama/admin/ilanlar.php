    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body table-responsive p-0" id="sonuc">
                    <table class="table table-hover text-nowrap">
                        ...
                        <a href="ilan-ekle.php?id=<?php echo $_GET['id']; ?>&katid=<?php echo $_GET['katid'] ?>"><button style="float:Left" type="submit"  class="btn btn-warning">CSV</button>
                        </a>
                        <thead>
                        <tr>
                            <th>İlan Resim</th>
                        ...
                        while ($ilanlargetir=$ilanlar->fetch(PDO::FETCH_ASSOC)) { ?>
                            <tr>
                                ...
                                <td><?php echo $ilanlargetir['ilan_model'] ?></td>
                                <td><?php echo $ilanlargetir['ilan_marka'] ?></td>
                                ...
                                <td>
                                    <form action="yukle.php" method="post">
                                        <input type="hidden" name="eskiresim" value="<?php echo $ilanlarcek['ilan_resim'] ?>">

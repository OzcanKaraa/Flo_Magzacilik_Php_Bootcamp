  ...
  <div class="container">
    <div class="row sticky-wrapper">
        ...
        $yuksek=$_POST['yuksek'];
          ...
          $ilanlar=$baglan->prepare("SELECT * from ilanlar where ilan_baslik  between $dusuk and $yuksek");

          $ilanlar->execute(array($_POST['id']));
            ...
            <div class="utf-listing-item compact">
			  <a href="ilandetay-<?php echo ($ilanlargetir['ilan_baslik']).'-'.$ilanlargetir['ilan_id'] ?>" class="utf-smt-listing-img-container">
				  ...
				  <ul class="listing-hidden-content">
					  <li><i class="fa fa-bed"></i>Model <span><?php echo $ilanlargetir['ilan_odasayisi'] ?></span></li>
				  </ul>
			  </a>
			</div>
          </div>
...
elseif (isset($_POST['listeleara'])) {
$arama=htmlspecialchars($_POST['arama']);
  $ilanlar=$baglan->prepare("SELECT * from ilanlar where ilan_baslik  LIKE '%$arama%' ");

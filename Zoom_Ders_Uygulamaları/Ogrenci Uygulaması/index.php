...
<body>
  <p style="text-align:center">
    <br><a href="form.php">Yeni Kayıt Ekle</a><br>
  </p>
  ...
  <?php
    ...
    foreach ($sorgu as $satir) {
      ...
      <td>$satir[tarih]</td>
      <td><a href='sil.php?op=ogrenci&id=$satir[id]'>Sil</a></td>
      </tr>";
      ...
      foreach ($sorgu2 as $satir2) {
        ...
        $notlar = "<b>Vize 1:</b> $satir2[vize1] - <b>Vize 2:</b> $satir2[vize2] - <b>Final:</b> $satir2[final] - <b>Ortalama:</b> $ortalama => {<a href='sil.php?op=not&id=$satir2[id]'>Sil</a>}";
      }
